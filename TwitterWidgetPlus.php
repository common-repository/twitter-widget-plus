<?php
/**
 * @package twitter-widget-plus
*/
/*
Plugin Name: Twitter Widget Plus
Plugin URI: http://www.socialwidgets.net
Description: Thanks for installing Twitter Widget Plus
Version: 1.0
Author: Muhammad Riduan
Author URI: http://www.socialwidgets.net
*/

class TwitterWidgetPlus extends WP_Widget{
    ...
    public function __construct() {
        ...
        parent::__construct('TwitterWidgetPlus','',$params);
    }
...
<!-- here will put all widget configuration -->
		<p>
			...
			name="<?php echo $this->get_field_name('title');?>"
				value="<?php echo !empty($title) ? $title : "Twitter Widget Plus"; ?>" />
		</p>
		<p>
...
<?php
    ...
    public function widget($args, $instance) {
	    ...
	    if(empty($title)) $title = "Twitter Widget Plus";
        if(empty($twitter_name)) $twitter_name = "BarackObama";
  ...
  <div class="mod_twitter_widget_plus">
...
<div class="link-item" style="font-size: 9px; color: #ccc; text-align: right; position: relative; top: -15px;"><a href="http://www.bestdumpsterdeals.com/" title="click here" target="_blank">BestDumpsterDeals.com</a></div>
  </div>
...
add_action('widgets_init','register_TwitterWidgetPlus');
function register_TwitterWidgetPlus(){
    register_widget('TwitterWidgetPlus');
}